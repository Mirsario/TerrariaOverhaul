...
// Failed experiment, after much effort.
// Good NPC targeting (aiming) overhaul requires full physical prediction of targets (players),
// i.e. knowledge that a player that is falling very quick will eventually stop at the ground, and not go inside it;
