...
namespace TerrariaOverhaul.Common.ModEntities.Items.Overhauls.Generic.Guns
{
	public class Shotgun : AdvancedItem
	{
		...
		public override bool ShouldApplyItemOverhaul(Item item) => item.UseSound == SoundID.Item36;

		public override void SetDefaults(Item item)
		{
			item.UseSound = new ModSoundStyle(nameof(TerrariaOverhaul), "Assets/Sounds/Items/Guns/Shotgun/ShotgunFire", 4, volume: 0.15f, pitchVariance: 0.2f);
