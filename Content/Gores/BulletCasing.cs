...
namespace TerrariaOverhaul.Content.Gores
{
	...
	{
		public static readonly ModSoundStyle BounceSound = new ModSoundStyle(nameof(TerrariaOverhaul), "Assets/Sounds/HitEffects/CasingBounce", 4, volume: 0.085f, pitchVariance: 0.2f);
